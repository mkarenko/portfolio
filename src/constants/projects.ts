...
export const projects: Project[] = [
  ...
  // 	framework: 'Xamarin',
  // 	technologies: [],
  // 	icon: 'https://play-lh.googleusercontent.com/5YM98ywuy3wUDm5KnzWifRwaKIOWZ-ccWLOGmXgmDp9QIxGFQ4DNd_7TJcWDsEVcpxQS',
  // 	logo: 'https://immoception.net/wp-content/uploads/2022/08/immoception-logo-150px.webp',
  ...
  // 	technologies: [],
  // 	icon: '',
  // 	logo: 'https://immowert4you.com/wp-content/uploads/2022/04/cropped-20539-Immowert4You-logo-design-_17-750x400.png',
  ...
  // // 	icon: '',
  // // 	logo: 'https://kluu-connect.com/wp-content/uploads/2022/12/KLuU-Schriftzug-weis_ohneHG.png-2048x820.png',
  // // 	android: '',
  // // 	ios: '',
  // // },
];
